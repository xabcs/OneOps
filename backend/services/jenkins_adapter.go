...
func (j *JenkinsAdapter) FetchUsers(baseURL string, authConfig map[string]interface{}) ([]models.ApplicationUser, error) {
	// 获取认证信息
...
func (j *JenkinsAdapter) FetchRoles(baseURL string, authConfig map[string]interface{}) ([]models.ApplicationRole, error) {
	// 获取认证信息
	username, _ := authConfig["username"].(string)
	password, _ := authConfig["password"].(string)
...
func (j *JenkinsAdapter) FetchGroups(baseURL string, authConfig map[string]interface{}) ([]models.ApplicationGroup, error) {
