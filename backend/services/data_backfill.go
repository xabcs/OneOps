...
func (s *DataBackfillService) CheckAndBackfill(server *models.Server) error {
...
func (s *DataBackfillService) fetchHistoricalMetrics(server *models.Server, startTime, endTime time.Time) ([]HistoricalMetric, error) {
