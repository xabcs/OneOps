...
-- 菜单管理（4个）
INSERT INTO sys_permissions (code, name, description, module, resource, action, level, sort_order, status, created_at, updated_at) VALUES
...
-- ======================================
-- 执行完成后，可运行以下查询验证：
-- SELECT COUNT(*) as total_permissions FROM sys_permissions;
-- SELECT module, COUNT(*) as count FROM sys_permissions GROUP BY module ORDER BY module;
