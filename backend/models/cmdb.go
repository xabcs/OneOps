...
type BusinessUnit struct {
	...
	Servers    []Server       `json:"servers,omitempty" gorm:"foreignKey:BusinessID"`
}
...
type Server struct {
	...
	CredentialID    uint      `json:"credentialId" gorm:"index"`                       // SSH凭证ID
	...
	// 关联
	Credential *SSHCredential `json:"credential,omitempty" gorm:"foreignKey:CredentialID"`
	Cabinet    *Cabinet       `json:"cabinet,omitempty" gorm:"foreignKey:CabinetID"`
	Tags       []ServerTag    `json:"tags,omitempty" gorm:"many2many:server_tag_relations;"`
	Groups     []ServerGroup  `json:"groups,omitempty" gorm:"many2many:server_group_relations;joinForeignKey:ServerID;joinReferences:GroupID"`
	CloudInfo  *CloudServer   `json:"cloudInfo,omitempty" gorm:"foreignKey:ServerID"`
}
...
type ServerTag struct {
	...
	// 关联
	Servers    []Server `json:"servers,omitempty" gorm:"many2many:server_tag_relations;"`
}
...
type ServerGroup struct {
	...
	Servers  []Server          `json:"servers,omitempty" gorm:"many2many:server_group_relations;joinForeignKey:ServerID;joinReferences:GroupID"`
}
