...
func (i *Initializer) syncPermissionRoutes() error {
	...
	routes := []routeDef{
		...
		{"GET", "/api/k8s/diagnostic/apps", "k8s.diagnostic.view"},
		{"GET", "/api/k8s/diagnostic/apps/:appName/agents", "k8s.diagnostic.view"},
		{"GET", "/api/k8s/diagnostic/overview", "k8s.diagnostic.view"},
		{"GET", "/api/k8s/diagnostic/executions", "k8s.diagnostic.view"},
		...
		{"DELETE", "/api/k8s/diagnostic/command-overrides/:id", "k8s.diagnostic.execute"},
		{"GET", "/api/k8s/diagnostic/webhook", "k8s.diagnostic.view"},
		{"POST", "/api/k8s/diagnostic/webhook/enable", "k8s.diagnostic.execute"},
		{"POST", "/api/k8s/diagnostic/webhook/disable", "k8s.diagnostic.execute"},
		{"POST", "/api/k8s/diagnostic/webhook/config", "k8s.diagnostic.execute"},
