...
func (j *JenkinsAdapter) FetchUsers(baseURL string, authConfig map[string]interface{}) ([]modelauth.ApplicationUser, error) {
	// 获取认证信息
...
func (j *JenkinsAdapter) FetchRoles(baseURL string, authConfig map[string]interface{}) ([]modelauth.ApplicationRole, error) {
	// 获取认证信息
	username, _ := authConfig["username"].(string)
	password, _ := authConfig["password"].(string)
...
func (j *JenkinsAdapter) FetchGroups(baseURL string, authConfig map[string]interface{}) ([]modelauth.ApplicationGroup, error) {
