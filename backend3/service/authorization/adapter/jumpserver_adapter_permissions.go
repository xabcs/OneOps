...
func (j *JumpserverAdapter) createAuthorizationRule(mapping *modelauth.AuthGroupPermissionMapping, permissionDetail map[string]interface{}) error {
	// 从权限详情中提取参数
...
func (j *JumpserverAdapter) assignAssetPermission(mapping *modelauth.AuthGroupPermissionMapping, permissionDetail map[string]interface{}) error {
...
func (j *JumpserverAdapter) assignNodePermission(mapping *modelauth.AuthGroupPermissionMapping, permissionDetail map[string]interface{}) error {
...
func (j *JumpserverAdapter) CheckGroupPermission(authGroupID uint, mapping *modelauth.AuthGroupPermissionMapping) (bool, error) {
	// 解析权限详情
	var permissionDetail map[string]interface{}
	if err := json.Unmarshal([]byte(mapping.PermissionDetail), &permissionDetail); err != nil {
