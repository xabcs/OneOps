...
func (r *ServerRepository) FindSSHCredentials(credentialType string) ([]modelcmdb.SSHCredential, error) {
...
func (r *ServerRepository) FindSSHCredentialByID(id uint) (*modelcmdb.SSHCredential, error) {
...
func (r *ServerRepository) CreateSSHCredential(credential *modelcmdb.SSHCredential) error {
	return r.db.Create(credential).Error
}

// UpdateSSHCredential 更新SSH凭证
func (r *ServerRepository) UpdateSSHCredential(id uint, updates map[string]interface{}) error {
	return r.db.Model(&modelcmdb.SSHCredential{}).Where("id = ?", id).Updates(updates).Error
}

// DeleteSSHCredential 删除SSH凭证
func (r *ServerRepository) DeleteSSHCredential(id uint) error {
