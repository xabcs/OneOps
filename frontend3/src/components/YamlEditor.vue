...
<template>
    <ElDialog v-model="visible" :title="title" width="900px" :close-on-click-modal="false" class="yaml-editor-dialog" @close="handleClose">
        <div class="yaml-editor-container">
            ...
            <!-- 备用简单编辑器 -->
            <textarea v-else v-model="yamlContent" class="simple-editor" :readonly="!isEditMode" spellcheck="false"></textarea>
