...
export async function fetchGetLoginLogs(params: Audit.LogQuery) {
  return request<Api.Common.PaginatingQueryRecord<Audit.LoginLog>>({
...
export async function fetchGetOperationLogs(params: Audit.LogQuery) {
  return request<Api.Common.PaginatingQueryRecord<Audit.OperationLog>>({
...
export async function fetchGetSystemEventLogs(params: Audit.LogQuery) {
  return request<Api.Common.PaginatingQueryRecord<Audit.SystemEventLog>>({
