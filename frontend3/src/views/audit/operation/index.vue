<script setup lang="tsx">
  ...
  function getMethodTag(method: string): { text: string; type: 'primary' | 'success' | 'warning' | 'danger' | 'info' } {
    const methodMap: Record<string, { text: string; type: 'primary' | 'success' | 'warning' | 'danger' | 'info' }> = {
