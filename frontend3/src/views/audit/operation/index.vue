<script setup lang="ts">
    ...
    function getMethodTag(method: string) {
      const methodMap: Record<string, { text: string; type: UI.ThemeColor | '' }> = {
        GET: { text: 'GET', type: '' },
        ...
        <ElCard class="card-wrapper">
            <ElForm :model="searchForm" inline class="search-form">
                ...
                <ElFormItem label="操作时间">
                    <ElDatePicker v-model="searchForm.startTime" type="datetime" placeholder="开始时间" value-format="YYYY-MM-DD HH:mm:ss" style="width: 200px" />
                    <span class="mx-2">至</span>
                    <ElDatePicker v-model="searchForm.endTime" type="datetime" placeholder="结束时间" value-format="YYYY-MM-DD HH:mm:ss" style="width: 200px" />
                </ElFormItem>
                <ElFormItem>
            ...
            <div class="mt-16px flex justify-end">
                <ElPagination v-model:current-page="pagination.page" v-model:page-size="pagination.pageSize" :page-sizes="[10, 20, 50, 100]" :total="total" layout="total, sizes, prev, pager, next, jumper" @current-change="handlePageChange" @size-change="handlePageSizeChange" />
            </div>
        </ElCard>
    </div>
</template>
