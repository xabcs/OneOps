...
<template>
    <div class="p-4">
        ...
        <div class="bg-card mb-4 flex items-center gap-4 rounded-lg p-4">
            ...
            <div class="flex items-center gap-2">
                <ElInput v-model="filters.labelSelector" placeholder="标签选择器 (可选)" style="width: 200px" clearable @change="handleSearch" />
            </div>
        ...
        <ElDialog v-model="showTerminal" title="Pod 终端" width="900px" fullscreen @close="closeTerminal">
            <PodTerminal v-if="showTerminal" :cluster-id="terminalProps.clusterId" :namespace="terminalProps.namespace" :pod-name="terminalProps.podName" :container-name="terminalProps.containerName" />
        </ElDialog>
    </div>
</template>
