...
<template>
  <div class="workloads-page p-24px">
    ...
    <ElTabs v-model="activeTab" @tab-change="onTabChange">
      <ElTabPane label="容器组" name="pods">
        <PodTab
          ...
          :selected-count="actions.selectedPods.value.length"
          @go-to-detail="goToDetail"
          @page-change="loadPods"
          @size-change="handlePageSizeChange"
          @selection-change="actions.handlePodSelectionChange"
          @select-all="actions.handlePodSelectAll"
          @clear-selection="actions.clearSelection"
          @pod-logs="actions.handlePodLogs"
          @pod-more-command="actions.handlePodMoreCommand"
      ...
      <ElTabPane label="无状态" name="deployments">
        <DeploymentTab
          ...
          :selected-count="actions.selectedDeployments.value.length"
          @go-to-detail="goToDetail"
          @page-change="loadDeployments"
          @size-change="handlePageSizeChange"
          @selection-change="actions.handleDeploymentSelectionChange"
          @select-all="actions.handleDeploymentSelectAll"
          @clear-selection="actions.clearSelection"
          @scale="actions.handleScale"
          @more-command="actions.handleMoreCommand"
          @batch-restart="actions.handleBatchRestart"
          @batch-delete="actions.handleBatchDelete"
        />
      </ElTabPane>
      ...
      <ElTabPane label="有状态" name="statefulsets">
        <WorkloadTab
          ...
          :loading="loading"
          :pagination="statefulSetsPagination"
          :selected-count="actions.selectedStatefulSets.value.length"
          @go-to-detail="goToDetail"
          @page-change="loadStatefulSets"
          @size-change="handlePageSizeChange"
          @selection-change="actions.handleStatefulSetSelectionChange"
          @select-all="actions.handleStatefulSetSelectAll"
          @clear-selection="actions.clearSelection"
          @workload-command="(cmd, row) => actions.handleWorkloadCommand('statefulset', cmd, row)"
          @batch-delete-by-type="actions.handleBatchDeleteByType"
        />
      </ElTabPane>
      ...
      <ElTabPane label="守护进程集" name="daemonsets">
        <WorkloadTab
          ...
          :data="daemonSetsData"
          :loading="loading"
          :pagination="daemonSetsPagination"
          :selected-count="actions.selectedDaemonSets.value.length"
          @go-to-detail="goToDetail"
          @page-change="loadDaemonSets"
          @size-change="handlePageSizeChange"
          @selection-change="actions.handleDaemonSetSelectionChange"
          @select-all="actions.handleDaemonSetSelectAll"
          @clear-selection="actions.clearSelection"
          @workload-command="(cmd, row) => actions.handleWorkloadCommand('daemonset', cmd, row)"
          @batch-delete-by-type="actions.handleBatchDeleteByType"
        />
      </ElTabPane>
      ...
      <ElTabPane label="任务" name="jobs">
        <WorkloadTab
          ...
          :selected-count="actions.selectedJobs.value.length"
          @go-to-detail="goToDetail"
          @page-change="loadJobs"
          @size-change="handlePageSizeChange"
          @selection-change="actions.handleJobSelectionChange"
          @select-all="actions.handleJobSelectAll"
          @clear-selection="actions.clearSelection"
          @workload-command="(cmd, row) => actions.handleWorkloadCommand('job', cmd, row)"
          @batch-delete-by-type="actions.handleBatchDeleteByType"
        />
      </ElTabPane>
      ...
      <ElTabPane label="定时任务" name="cronjobs">
        <WorkloadTab
          ...
          :selected-count="actions.selectedCronJobs.value.length"
          @go-to-detail="goToDetail"
          @page-change="loadCronJobs"
          @size-change="handlePageSizeChange"
          @selection-change="actions.handleCronJobSelectionChange"
          @select-all="actions.handleCronJobSelectAll"
          @clear-selection="actions.clearSelection"
          @workload-command="(cmd, row) => actions.handleWorkloadCommand('cronjob', cmd, row)"
          @batch-delete-by-type="actions.handleBatchDeleteByType"
        />
      </ElTabPane>
    </ElTabs>
    ...
    <ScaleDialog
      v-model:show="actions.showScaleDialog.value"
      :deployment="actions.selectedDeployment.value"
      :scale-data="actions.scaleData"
      @submit="actions.handleScaleSubmit"
    />

    <LogDialog
      v-model:show="actions.showLogDialog.value"
      :title="`日志: ${actions.selectedResource.value?.name}${actions.selectedResource.value?.containers?.[0]?.name ? ' (' + actions.selectedResource.value.containers[0].name + ')' : ''}`"
      :content="actions.logDialogContent.value"
    />

    <YamlEditor
      v-model="actions.showYamlDialog.value"
      :title="actions.yamlDialogTitle.value"
      :yaml="actions.yamlContent.value"
      :can-edit="true"
      :on-apply="actions.handleYamlApply"
    />
  </div>
</template>
