        ...
        <ElTabs v-model="activeTab" @tab-change="handleTabChange">
            ...
            <ElTabPane label="配置项" name="configmaps">
                <div v-loading="loading" class="table-container">
                    <ElTable :data="configmapsData" class="config-table" :header-cell-style="{ background: '#f5f7fa', color: '#303133', fontWeight: '600' }" :row-style="{ backgroundColor: 'transparent' }" :cell-style="{ backgroundColor: 'transparent', padding: '8px 0' }">
                    ...
                    <div class="bottom-toolbar">
                        <ElPagination v-model:current-page="configmapsPagination.page" v-model:page-size="configmapsPagination.pageSize" :total="configmapsPagination.itemCount" :page-sizes="[10, 20, 50, 100]" layout="total, sizes, prev, pager, next, jumper" @current-change="loadConfigMaps" @size-change="handlePageSizeChange" />
                    </div>
                </div>
            </ElTabPane>
            ...
            <ElTabPane label="保密字典" name="secrets">
                <div v-loading="loading" class="table-container">
                    <ElTable :data="secretsData" class="config-table" :header-cell-style="{ background: '#f5f7fa', color: '#303133', fontWeight: '600' }" :row-style="{ backgroundColor: 'transparent' }" :cell-style="{ backgroundColor: 'transparent', padding: '8px 0' }">
                        <ElTableColumn prop="name" label="名称" min-width="200" align="left" />
                        <ElTableColumn prop="namespace" label="命名空间" min-width="150" align="left" />
                        ...
                        <ElTableColumn label="数据键" min-width="300" align="left">
                            <template #default="{ row }">
                                <ElTag v-for="(key, index) in row.dataKeys" :key="index" size="small" class="mb-4px mr-4px" type="warning">
                                    ***
                                </ElTag>
                            </template>
                        </ElTableColumn>
                    ...
                    <div class="bottom-toolbar">
                        <ElPagination v-model:current-page="secretsPagination.page" v-model:page-size="secretsPagination.pageSize" :total="secretsPagination.itemCount" :page-sizes="[10, 20, 50, 100]" layout="total, sizes, prev, pager, next, jumper" @current-change="loadSecrets" @size-change="handlePageSizeChange" />
                    </div>
                </div>
            </ElTabPane>
        </ElTabs>
