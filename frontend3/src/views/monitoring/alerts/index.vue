        ...
        <ElCard shadow="never">
            <ElTable v-loading="loading" :data="alertList" border stripe>
                ...
                <ElTableColumn label="操作" width="100" align="center" fixed="right">
                    <template #default="{ row }">
                        <ElButton v-if="!row.acknowledged && !row.resolvedAt" type="primary" link size="small" @click="handleAcknowledge(row)">
                            确认
                        </ElButton>
            ...
            <div class="mt-4 flex justify-end">
                <ElPagination v-model:current-page="filterForm.page" v-model:page-size="filterForm.pageSize" :total="totalCount" :page-sizes="[20, 50, 100]" layout="total, sizes, prev, pager, next" @current-change="handlePageChange" @size-change="handlePageSizeChange" />
            </div>
        </ElCard>
    </div>
</template>
