...
<template>
  <ListPageLayout title="巡检报告" description="生成并管理主机巡检、安全合规与容量分析报告">
    <!-- 生成报告表单与报告说明 -->
    <template #hero>
      <!-- 创建报告 -->
      <ElCard shadow="never" class="card-static" header="生成报告">
      ...
      <!-- 报告说明 -->
      <ElCard shadow="never" class="card-static" header="报告说明">
    ...
    <!-- 报告历史 -->
    <ElTable v-loading="loading" :data="reportHistory" border stripe height="100%">
