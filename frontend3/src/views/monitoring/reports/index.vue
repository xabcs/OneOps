                ...
                <ElRow :gutter="16">
                    ...
                    <ElCol :xs="24">
                        <ElFormItem label="选择主机">
                            <ElSelect v-model="reportForm.serverIds" multiple filterable placeholder="请选择要生成报告的主机" style="width: 100%">
                    ...
                    <ElCol :xs="24">
                        <ElFormItem>
                            <ElButton type="primary" :loading="generating" :disabled="reportForm.serverIds.length === 0" @click="generateReport">
                                <ElIcon :size="16">
                                    <Document />
                                </ElIcon>
                                {{ generating ? '生成中...' : '生成报告' }}
