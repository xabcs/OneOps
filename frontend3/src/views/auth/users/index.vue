    ...
    <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
        ...
        <ElCard class="card-wrapper sm:flex-1-hidden">
            ...
            <div class="h-[calc(100%-52px)]">
                <ElTable v-loading="loading" height="100%" :data="tableData" :border="false" class="sm:h-full">
                    ...
                    <ElTableColumn label="用户组" align="center" min-width="200">
                        <template #default="{ row }">
                            <div class="flex items-center justify-center gap-2">
                                <ElTag v-for="group in row.groups" v-if="row.groups && row.groups.length > 0" :key="group.id" type="primary" size="small">
                                    {{ group.name }}
                                </ElTag>
            ...
            <ElDescriptions :column="1" border>
                ...
                <ElDescriptionsItem label="初始密码">
                    <div class="flex items-center gap-2">
                        ...
                        <ElButton size="small" type="primary" @click="
                () => {
            ...
            <div class="mb-4">
                <div class="mb-4 flex items-center gap-2">
                    ...
                    <ElSelect v-model="groupFormData.groupId" placeholder="选择用户组" style="width: 200px">
                        <ElOption v-for="group in allGroups" :key="group.id" :label="`${group.name} (${group.code})`" :value="group.id" />
                    </ElSelect>
