const local: App.I18n.Schema = {
  ...
  theme: {
    ...
    content: {
      ...
      presets: {
        subtle: 'Porcelain Slate',
        techBlue: 'Quiet Blue',
        vibrantPurple: 'Twilight Purple',
        freshGreen: 'Celadon Green',
        warmOrange: 'Warm Sand',
        graphite: 'Graphite',
        aurora: 'Aurora Teal',
        midnight: 'Midnight Blue',
        orchid: 'Wisteria Mist',
        jade: 'Jade',
        champagne: 'Champagne',
        ...
        moss: 'Moss Green',
        dusk: 'Dusk Lilac',
        moonAurora: 'Moon Aurora',
        peachMist: 'Peach Mist',
        lilacSpring: 'Lilac Spring',
        aquaBlossom: 'Aqua Blossom',
        lemonLilac: 'Lemon Lilac',
        mintPetal: 'Mint Petal',
        skyApricot: 'Sky Apricot',
        roseGlacier: 'Rose Glacier',
        lilacFern: 'Lilac Fern',
        cloudMelon: 'Cloud Melon',
      ...
      fields: {
        ...
        gradientMiddle: 'Gradient Middle Color',
        ...
        padding: 'Padding',
        defaultBg: 'Default Card Background',
        defaultStart: 'Default Gradient Start',
        defaultEnd: 'Default Gradient End',
        successBg: 'Success Background',
        successStart: 'Success Gradient Start',
        successEnd: 'Success Gradient End',
        warningBg: 'Warning Background',
        warningStart: 'Warning Gradient Start',
        warningEnd: 'Warning Gradient End',
        ...
        rowBorder: 'Row Border Color',
        stripedBg: 'Striped Row Background',
        inputBg: 'Input Background',
        inputBorder: 'Input Border',
        inputHoverBorder: 'Input Hover Border',
