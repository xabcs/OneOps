...
func InitSessionManager() {
	if globalSessionManager == nil {
		globalSessionManager = NewSessionManager(NewBastionService())
	}
}
...
func NewSSHWebSocketHandler() *SSHWebSocketHandler {
	return &SSHWebSocketHandler{
		bastionService: NewBastionService(),
...
func (h *SSHWebSocketHandler) connectToServer(session *BastionSession) (*ssh.Client, error) {
	// 获取服务器信息
...
func (h *SSHWebSocketHandler) forwardWebSocketToSSH(conn *websocket.Conn, stdinPipe io.WriteCloser, session *BastionSession, ctx context.Context) {
...
func (h *SSHWebSocketHandler) forwardSSHToWebSocket(stdoutPipe io.Reader, conn *websocket.Conn, session *BastionSession, ctx context.Context) {
...
func NewSessionManager(bastionService *BastionService) *SessionManager {
