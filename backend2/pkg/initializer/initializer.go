...
func (i *Initializer) migrateSchema() error {
	...
	if err := db.AutoMigrate(
		...
		&cmdb.BusinessUnit{},
		&cmdb.SSHCredential{},
		&system.AttributeDefinition{},
		&cmdb.AgentVersion{},
		&cmdb.AgentUpgradeTask{},
		&k8s.DiagnosticHistory{},
		&k8s.DiagnosticConfig{},
		&k8s.DiagnosticPermission{},
		&authorization.Application{},
		&authorization.ApplicationRole{},
		&authorization.ApplicationUser{},
		&authorization.ApplicationGroup{},
		&authorization.ApplicationAuthorizationRule{},
		&authorization.GroupBinding{},
		&authorization.AuthUser{},
		&authorization.AuthGroup{},
		&authorization.AuthUserGroup{},
		&authorization.AuthGroupPermissionMapping{},
		&authorization.ApplicationOperationLog{},
		&authorization.UserIdentityMapping{},
		&authorization.GroupBindingExecution{},
		&authorization.PermissionAssignmentStatus{},
	); err != nil {
	...
	if err := db.AutoMigrate(
		...
		&cmdb.Server{},
		&cmdb.ServerTag{},
		&cmdb.ServerTagRelation{},
		&cmdb.ServerGroup{},
		&cmdb.ServerGroupRelation{},
		&cmdb.ServerCredential{},
		&system.ServerAttribute{},
		&cmdb.CloudServer{},
		&cmdb.AssetChange{},
		&cmdb.AssetAccessPolicy{},
		&cmdb.BastionSession{},
		&cmdb.BastionCommand{},
		&cmdb.BastionFileTransfer{},
		&cmdb.BastionApproval{},
	); err != nil {
...
func (i *Initializer) initPermissionsFromSQL() error {
	...
	// 统计权限数量
	var count int64
	if err := db.Model(&system.Permission{}).Count(&count).Error; err != nil {
